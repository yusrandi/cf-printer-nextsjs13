...
export default function EvidenceModalDelete({ showModal, setShowModal, evidence, handleSubmit, submitClicked }: Props) {
            ...
            <div className="w-full bg-white overflow-hidden md:max-w-md md:rounded-2xl md:border md:border-gray-100 md:shadow-xl">
                <div className="flex flex-col items-center justify-center space-y-3 bg-white px-4 py-6 pt-8 text-center md:px-16">
                    ...
                    <p className="text-sm text-gray-500">
                        ...
                        anda yakin ingin menghapus {evidence.evidenceCode}?.
                    </p>
